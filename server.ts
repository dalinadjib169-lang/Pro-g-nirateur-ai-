...
async function startServer() {
  ...
  app.post("/api/generate", async (req, res) => {
    try {
      ...
      7. **الرموز الرياضية (مناهج الجيل الثاني - الجزائر)**: يمنع منعاً باتاً استخدام الحروف العربية (مثل س، ص، أ، ب، ج، ع) في الرياضيات والفيزياء. يجب كتابة جميع المعادلات، المتغيرات، الدوال، والأرقام باللغة الفرنسية (اللاتينية: x, y, z, a, b, c) ومن اليسار إلى اليمين حصرياً، لأن مناهج الجيل الثاني في الجزائر تعتمد الرموز الفرنسية في المواد العلمية (مثال: بدلاً من (أ + ب)² اكتب (a + b)² وبدلاً من س اكتب x).
