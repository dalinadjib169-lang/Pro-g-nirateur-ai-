...
import { Moon, Sun, Save, FileText, FileSpreadsheet, ListTodo, Download, Printer, User, School, BookOpen, Layers, Palette, Sparkles, Table, Hexagon, Smile, GraduationCap, Heart, Coffee, Zap, ZoomIn, ZoomOut, Maximize, Languages, Droplet, ImagePlus, Leaf, Star, Volume2, VolumeX } from 'lucide-react';
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
          <div className="flex items-center gap-2 md:gap-4 w-full md:w-auto justify-center md:justify-start">
            ...
            <div className="relative overflow-hidden px-2 py-1 group cursor-default text-center md:text-right">
              ...
              <h1 className="relative z-0 text-2xl md:text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-red-600 dark:from-amber-400 dark:to-red-500 font-sans tracking-tight leading-none drop-shadow-sm whitespace-nowrap">
                Générateur Pro
              </h1>
